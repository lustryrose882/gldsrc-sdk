...
constexpr auto COORD_INTEGER_BITS                     = 13;
constexpr auto COORD_FRACTIONAL_BITS                  = 5;
constexpr auto COORD_DENOMINATOR                      = (1 << (COORD_FRACTIONAL_BITS));
constexpr auto COORD_RESOLUTION                       = (1.0f / (COORD_DENOMINATOR));

// Special threshold for networking multiplayer origins
constexpr auto COORD_INTEGER_BITS_MP                  = 12;
constexpr auto COORD_FRACTIONAL_BITS_MP_LOWPRECISION  = 3;
constexpr auto COORD_DENOMINATOR_LOWPRECISION         = (1 <<  (COORD_FRACTIONAL_BITS_MP_LOWPRECISION));
constexpr auto COORD_RESOLUTION_LOWPRECISION          = (1.0f / (COORD_DENOMINATOR_LOWPRECISION));

constexpr auto NORMAL_FRACTIONAL_BITS                 = 11;
constexpr auto NORMAL_DENOMINATOR                     = ((1 << (NORMAL_FRACTIONAL_BITS)) - 1);
constexpr auto NORMAL_RESOLUTION                      = (1.0f / (NORMAL_DENOMINATOR));
...
static_assert(MAX_COORD_INTEGER == (1 << COORD_INTEGER_BITS), "MAX_COORD_INTEGER does not match COORD_INTEGER_BITS");
...
//
// | SignBit:1 | FractionPart:12 |		Total
// --------------------------------------------------------------------------------------------------
//			1		xxxxxxxxxxx			12
//
///////////////////////////////////////////////////////////////////////////////////////////////////////
