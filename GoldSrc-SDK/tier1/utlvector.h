...
public:
	...
	int InsertMultipleAfter(int elem, int num, const T *pToCopy = nullptr);
	...
	int SortedFind(const T& search, bool (*pfnLessFunc)(const T& src1, const T& src2, void *pCtx), void *pLessContext) const;
	int SortedFind(const T& search, bool (*pfnLessFunc)(const T& src1, const T& src2)) const;
	int SortedFindFirst(const T& search, bool (*pfnLessFunc)(const T& src1, const T& src2, void *pCtx), void *pLessContext) const;
	int SortedFindLessOrEqual(const T& search, bool (*pfnLessFunc)(const T& src1, const T& src2, void *pCtx), void *pLessContext, int start, int end) const;
	int SortedFindLessOrEqual(const T& search, bool (*pfnLessFunc)(const T& src1, const T& src2, void *pCtx), void *pLessContext) const;
	int SortedFindLessOrEqual(const T& search, bool (*pfnLessFunc)(const T& src1, const T& src2), int start, int end) const;
	int SortedFindLessOrEqual(const T& search, bool (*pfnLessFunc)(const T& src1, const T& src2)) const;
	...
	int SortedInsert(const T &src, bool (*pfnLessFunc)(const T& src1, const T& src2, void *pCtx), void *pLessContext);
	int SortedInsert(const T &src, bool (*pfnLessFunc)(const T& src1, const T& src2));
	...
	void Sort_s(void *context, int (*pfnCompare)(void *, const T *, const T *));
	...
	void Sort_s(void *context, bool (*pfnLessFunc)(const T& src1, const T& src2, void *pCtx));
...
template <typename T, class A>
CUtlVector<T, A>::CUtlVector(T *pMemory, int allocationCount, int numElements) :
...
template <typename T, class A>
inline const T *CUtlVector<T, A>::Base() const
{
	return m_Memory.Base();
}
...
template <typename T, class A>
int CUtlVector<T, A>::SortedFind(const T& search, bool (*pfnLessFunc)(const T& src1, const T& src2, void *pCtx), void *pLessContext) const
{
...
// You must sort the list before using or your results will be wrong
template <typename T, class A>
int CUtlVector<T, A>::SortedFind(const T& search, bool (*pfnLessFunc)(const T& src1, const T& src2)) const
{
	int start = 0, stop = Count() - 1;
	while (start <= stop)
	{
...
// You must sort the list before using or your results will be wrong
template <typename T, class A>
int CUtlVector<T, A>::SortedFindFirst(const T& search, bool (*pfnLessFunc)(const T& src1, const T& src2, void *pCtx), void *pLessContext) const
{
	int start = 0, stop = Count() - 1;
	while (start <= stop)
	{
...
template <typename T, class A>
int CUtlVector<T, A>::SortedFindLessOrEqual(const T& search, bool (*pfnLessFunc)(const T& src1, const T& src2, void *pCtx), void *pLessContext, int start, int stop) const
{
	while (start <= stop)
	{
		int mid = (start + stop) >> 1;
...
template <typename T, class A>
int CUtlVector<T, A>::SortedFindLessOrEqual(const T& search, bool (*pfnLessFunc)(const T& src1, const T& src2, void *pCtx), void *pLessContext) const
{
	return SortedFindLessOrEqual(search, pfnLessFunc, pLessContext, 0, Count() - 1);
}

template <typename T, class A>
int CUtlVector<T, A>::SortedInsert(const T &src, bool (*pfnLessFunc)(const T& src1, const T& src2, void *pCtx), void *pLessContext)
{
...
template <typename T, class A>
int CUtlVector<T, A>::SortedFindLessOrEqual(const T& search, bool (*pfnLessFunc)(const T& src1, const T& src2), int start, int stop) const
{
	while (start <= stop)
	{
		int mid = (start + stop) >> 1;
...
// Sorted find, with no context pointer
template <typename T, class A>
int CUtlVector<T, A>::SortedFindLessOrEqual(const T& search, bool (*pfnLessFunc)(const T& src1, const T& src2)) const
{
...
template <typename T, class A>
int CUtlVector<T, A>::SortedInsert(const T &src, bool (*pfnLessFunc)(const T& src1, const T& src2))
{
...
// Sorts the vector
template <typename T, class A>
void CUtlVector<T, A>::Sort(bool (*pfnLessFunc)(const T& src1, const T& src2))
{
	std::sort(begin(), end(),
...
// Sorts the vector
template <typename T, class A>
void CUtlVector<T, A>::Sort(bool(*pfnLessFunc)(const T& src1, const T& src2, void *pCtx), void *pLessContext)
{
	std::sort(begin(), end(),
...
// Sorts the vector
template <typename T, class A>
void CUtlVector<T, A>::Sort_s(void *context, int (*pfnCompare)(void *,const T *, const T *))
{
	std::sort(begin(), end(),
...
// Sorts the vector
template <typename T, class A>
void CUtlVector<T, A>::Sort_s(void *context, bool (*pfnLessFunc)(const T& src1, const T& src2, void *pCtx))
{
	std::sort(begin(), end(),
...
void CUtlVector<T, A>::Swap(CUtlVector<T, A> &vec)
{
	...
	SWAP<int>(this->m_Size, vec.m_Size);
}
...
template <typename T, class A>
inline void CUtlVector<T, A>::PurgeAndDeleteArray()
{
	for (int i = 0; i < m_Size; i++)
	{
		delete[] Element(i);
...
template <class T>
class CUtlVectorAutoPurge: public CUtlVector<T>
{
public:
	~CUtlVectorAutoPurge()
	{
...
template <class T>
class CUtlVectorAutoArrayPurge: public CUtlVector<T>
{
public:
	~CUtlVectorAutoArrayPurge()
	{
		this->PurgeAndDeleteArray();
	}
};

// easy string list class with dynamically allocated strings. For use with V_SplitString, etc.
// Frees the dynamic strings in destructor.
class CUtlStringList: public CUtlVectorAutoArrayPurge<char *>
{
public:
	void CopyAndAddToTail(char const *pString)			// clone the string and add to the end
	{
		...
		strncpy(pNewStr, pString, len);
		int idx = AddToTail(pNewStr);
		REFERENCE(idx);
	}

	static int SortFunc(char *const *sz1, char *const *sz2)
	{
...
template <class T, class A = CUtlMemoryShared<T>>
class CUtlVectorShared: public CUtlVector<T, A>
{
public:
	// constructors
	...
	using alloc_t = typename A::CAllocator::alloc_t;
	using realloc_t = typename A::CAllocator::realloc_t;
	using free_t = typename A::CAllocator::free_t;
	...
	{
		return CUtlVector<T, A>::ShiftElementsRight(elem, num);
	}

	virtual void ShiftElementsLeft(int elem, int num)
	{
		return CUtlVector<T, A>::ShiftElementsLeft(elem, num);
	}
};
