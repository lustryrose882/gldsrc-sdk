...
const char *MD5_Print(unsigned char *hash, int hashlen)
{
	static char szReturn[64] = {0};
	...
	for (int i = 0; i < hashlen; i++)
	{
		...
		_snprintf(doublet, sizeof(doublet), "%02x", c);
		strncat(szReturn, doublet, sizeof(szReturn));
	}
