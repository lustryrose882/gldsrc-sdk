...
{
public:
	CRBTreeBalanceListener() : m_pTarget(nullptr) { }
...
public:
	...
	static bool BDiffRBTrees(const CUtlRBTree<T, I, L, E> &rbTreeBase, const CUtlRBTree<T, I, L, E> &rbTreeCompare, CUtlRBTree<T, I, L, E> *prbTreeAdditions = nullptr, CUtlRBTree<T, I, L, E> *prbTreeDeletions = nullptr);
...
// is never true for unsigned types, but specializing the template seems like overkill
template <class T, class I, typename L, class E>
...
{
	//if (i == InvalidIndex() || i >= MaxElement())
	//{
	//	return false;
	//}
...
// Utility function for diffing RBTrees
template <class T, class I, typename L, class E>
bool CUtlRBTree<T, I, L, E>::BDiffRBTrees(const CUtlRBTree<T, I, L, E> &rbTreeBase, const CUtlRBTree<T, I, L, E> &rbTreeCompare, CUtlRBTree<T, I, L, E> *prbTreeAdditions /* = nullptr */, CUtlRBTree<T, I, L, E> *prbTreeDeletions /* = nullptr */)
{
	...
	{
		const T *pValBase = nullptr;
		const T *pValCompare = nullptr;
