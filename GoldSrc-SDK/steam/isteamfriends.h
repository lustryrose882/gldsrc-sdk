...
enum EFriendAvatarSize
{
	k_EFriendAvatarSize32x32 = 0,
	k_EFriendAvatarSize64x64 = 1,
	k_EFriendAvatarSize184x184 = 2,
	k_EFriendAvatarSizeMAX = 3,
};

enum EPersonaStateFlag
{
	k_ePersonaStateFlagRichPresence = 0x01,
	k_ePersonaStateFlagInJoinableGame = 0x02,
	k_ePersonaStateFlagGolden = 0x04,
	k_ePersonaStateFlagClientTypeWeb = 0x100,
	k_ePersonaStateFlagClientTypeMobile = 0x200,
	k_ePersonaStateFlagClientTypeTenfoot = 0x400,
	k_ePersonaStateFlagClientTypeVR = 0x800,
	k_ePersonaStateFlagLaunchTypeGamepad = 0x1000
};
...
// Interface to accessing information about individual users,
...
public:
	...
	// friend iteration
	// takes a set of EFriendFlags, and returns the number of users the client knows about who meet that criteria
	...
	// iFriendFlags can be the union (binary or, |) of one or more EFriendFlags values
	...
	virtual void UpdatePlayerAvatar(CSteamID &steamIDFriend, int index) = 0;
	virtual void ClearPlayerAvatars() = 0;
};

#else

#define ISteamFriends ISteamFriends013
