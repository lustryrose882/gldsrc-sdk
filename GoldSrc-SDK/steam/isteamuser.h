...
public:
	...
	// uint32_t unIPServer, uint16_t usPortServer - the IP address of the game server
	...
	// a little bit after this function is called. GetVoice() should continue to be called until it returns k_EVoiceResultNotRecording
...
#define ISteamUser ISteamUser016
...
// Result from RequestEncryptedAppTicket
...
// Sent to your game in response to a steam://gamewebcallback/ command
