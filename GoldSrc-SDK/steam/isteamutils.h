...
enum ESteamAPICallFailure
{
	...
	k_ESteamAPICallFailureNetworkFailure = 1,		// The network connection to the Steam servers has been lost, or was already broken.
													// A SteamServersDisconnected_t callback will be sent around the same time,
													// and a SteamServersConnected_t callback will be sent when the client is able to talk to the Steam servers again
...
// Interface to user independent utility functions
...
#define ISteamUtils ISteamUtils005
...
struct SteamAPICallCompleted_t
{
	...
	SteamAPICall_t m_hAsyncCall;	// The handle of the Steam API Call that completed.
	int m_iCallback;				// This is the k_iCallback constant which uniquely identifies the completed callback
	int m_cubParam;					// The size in bytes of the completed callback
};
