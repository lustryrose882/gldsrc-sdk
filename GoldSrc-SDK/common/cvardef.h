...
#define FCVAR_PRIVILEGED		(1<<10) // Protect privileged CVar from external  interference
#define FCVAR_RESTRICTED		(1<<11) // Protect privileged CVar by cl_filterstuffcmd
#define FCVAR_STRIPNEWLINE		(1<<12) // CVar can contain ';' or '\n', strip 'em
#define FCVAR_FILTERPATH		(1<<13) // CVar can contain path, so filter bad path
