...
#define CULL_FRUSTUM_POINT        BIT(0)
#define CULL_FRUSTUM_SPHERE       BIT(1)
#define CULL_FRUSTUM_PLANE        BIT(2)
#define CULL_PVS                  BIT(3)

#define LIGHT_NONE                BIT(4)
#define LIGHT_COLOR               BIT(5)
#define LIGHT_INTENSITY           BIT(6)

#define RENDER_FACEPLAYER         BIT(7) // m_vAngles == Player view angles
#define RENDER_FACEPLAYER_ROTATEZ BIT(8) // Just like above but m_vAngles.z is untouched so the sprite can rotate.
