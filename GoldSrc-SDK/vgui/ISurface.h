...
// Wraps contextless windows system functions
...
#ifdef _WIN32
	// WARNING: This virtual exists only inside vgui2.dll, not engine
	// virtual void SetCurrentContextPanel(VPANEL panel) = 0;
#endif
